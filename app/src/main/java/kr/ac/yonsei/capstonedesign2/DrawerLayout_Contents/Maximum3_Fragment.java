...
public class Maximum3_Fragment extends Fragment {

    private static ProgressBar progressBar3;
    public static TextView txt_guide3;

    // Firebase
    private static FirebaseDatabase mDatabase;
    public static DatabaseReference mRef3;
    public static ChildEventListener mChildListener3;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_maximum3, container, false);

        progressBar3 = v.findViewById(R.id.progress_maximum3);
        txt_guide3 = v.findViewById(R.id.txt_max3_guide);

        mDatabase = FirebaseDatabase.getInstance();
        mRef3 = mDatabase.getReference("user_id")
                .child("data");

        mChildListener3 = new ChildEventListener() {
            @Override
    ...
    public static class ProgressBarAsyncTask3 extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected void onProgressUpdate(Integer... values) {
            if (values[0] < 200) {
                ...
                mRef3.removeEventListener(mChildListener3);
            }
            if (values[0] == 200) {
                txt_guide3.setText("Relax your muscle");
            }
            if (values[0] == 400) {
                txt_guide3.setText("Done");
            }
